...
Extraction, nettoyage, harmonisation et structuration de données provenant de multiples API et portails Open Data.

Analyses statistiques

Analyse temporelle des indicateurs.

Étude des corrélations et dépendances.

ACP / AFCM / classifications de pays.

Analyse spatiale et cartographie des résultats.

Modélisation prédictive
Prévision des tendances climatiques ou socio-économiques selon la problématique retenue.

Développement de l’application R Shiny

Tableau de bord interactif.

Visualisations et cartes dynamiques.

Rapport & synthèse
Présentation de l’approche, des résultats, limites, perspectives.

🛠️ Technologies & Outils

R (tidyverse, ggplot2, leaflet, shiny, forecast, FactoMineR…)

SAS (si utilisé dans le projet)
